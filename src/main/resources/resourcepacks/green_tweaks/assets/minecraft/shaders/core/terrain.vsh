...
#moj_import <jabsfixedworldandui:wavy_core/config.glsl>
#moj_import <jabsfixedworldandui:wavy_core/util.glsl>
#moj_import <jabsfixedworldandui:wavy_core/main.vsh>
